...
function gui.dashboard.init()
	...
	dashboardFrame.Position = UDim2.new(1, -dashboardWidth - 10 * scale, 1, -titleBarHeight - 10 * scale)
	...
	task.spawn(function()
		while dashboardState.window do
			if dashboardState.isExpanded and dashboardState.timeoutActive then
