...
function gui.dashboard.open()
	if not dashboardState.isMinimized then return end
...
function gui.dashboard.minimize()
	if dashboardState.isMinimized then return end
...
function gui.dashboard.init()
	...
	minimizedButton.BackgroundColor3 = palette.sliderFill
	minimizedButton.BackgroundTransparency = 0.1
	minimizedButton.BorderSizePixel = 1
	minimizedButton.BorderColor3 = palette.border
	minimizedButton.BorderMode = Enum.BorderMode.Inset
	minimizedButton.Text = "!"
	minimizedButton.TextColor3 = palette.text
	...
	minimizedButton.MouseEnter:Connect(function()
		minimizedButton.BackgroundColor3 = Color3.fromRGB(65, 145, 230)
	end)
